...
AHackermanCharacter::AHackermanCharacter()
{
...
void AHackermanCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AHackermanCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
